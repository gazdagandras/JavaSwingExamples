...
public class ColoredDigitWindow extends javax.swing.JFrame {
    ...
    private void cbColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbColorActionPerformed
        switch (cbColor.getSelectedIndex()) {
            ...
            case 4:
                ...
                break;
            default:
                JOptionPane.showMessageDialog(this, "This item has not been set!", "Invalid color!", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void cbValueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbValueActionPerformed
        // Sollution A:
//        switch (cbValue.getSelectedIndex()) {
//            case 0:
//                lblNumber.setText("1");
//                break;
//            case 1:
...
//        }
        // Sollution B:
        lblNumber.setText(Integer.toString(cbValue.getSelectedIndex() + 1));                
